<form class="form" action="auth.php" method="post">
    <div class="form__row">
            ...
            <input class="form__input<?php if (isset($auth['email'])) {echo " form__input--error";}?>" type="text" name="email" id="email" value="<?php if (isset($field['email'])) {echo $field['email'];} ?>" placeholder="Введите e-mail">
